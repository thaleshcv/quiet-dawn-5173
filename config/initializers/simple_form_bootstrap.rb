...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: "div", class: "field", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.use :input, class: "input", wrap_with: { tag: "div", class: "control" }, error_class: "is-invalid", valid_class: "is-valid"
    b.use :full_error, wrap_with: { tag: "p", class: "help is-danger" }
    b.use :hint, wrap_with: { tag: "small", class: "form-text text-muted" }
  end

  # vertical input for boolean
  config.wrappers :vertical_boolean, tag: "div", class: "field", error_class: "is-invalid", valid_class: "is-valid" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :form_check_wrapper, tag: "div", class: "control" do |bb|
      bb.wrapper :form_control_wrapper, tag: "label", class: "checkbox" do |bl|
        bl.use :input, error_class: "is-invalid", valid_class: "is-valid"
        bl.use :label_text
        bl.use :full_error, wrap_with: { tag: "p", class: "help is-danger" }
        bl.use :hint, wrap_with: { tag: "small", class: "form-text text-muted" }
      end
    end
  end
  ...
  config.wrappers :horizontal_form, tag: "div", class: "form-group row", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    ...
    b.wrapper :grid_wrapper, tag: "div", class: "col-sm-9" do |ba|
      ...
      ba.use :full_error, wrap_with: { tag: "p", class: "help is-danger" }
